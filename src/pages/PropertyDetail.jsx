...
<div className="bg-gray-200 w-80 rounded-lg md:rounded-lg lg:rounded-lg md:ml-52  m-10 md:w-96">
  <div>
...
<div className="-mt-10 ">
  ...
  <h1 className="text-center text-sm md:text-lg"> recibir conmunicaciones de marketing</h1>
    ...
    <div>
      <div >
       <h1 className="ml-5 mt-5 text-verdes text-lg md:text-2xl md:ml-6 lg:text-4xl mb-3">Descripción</h1> 
